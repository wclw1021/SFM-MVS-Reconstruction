...
% Tested on Matlab r2023a with Computer Vision System Toolbox
...
% change from RGB to gray style
imageA  = rgb2gray(colorA);
imageB  = rgb2gray(colorB);

% MetricThreshold is a parameter to control the quality of features. Lower,
% worse quality but more points
